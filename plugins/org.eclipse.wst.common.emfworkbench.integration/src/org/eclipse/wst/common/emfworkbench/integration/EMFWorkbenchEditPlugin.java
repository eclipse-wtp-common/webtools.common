...
import org.eclipse.wst.common.emfworkbench.PassthruResourceSet;
...
public class EMFWorkbenchEditPlugin extends Plugin {
	...
	public EMFWorkbenchEditPlugin(IPluginDescriptor descriptor) {
		...
		plugin = this;
		try {
			resourceBundle = ResourceBundle.getBundle("org.eclipse.wst.common.emfworkbench.integration.EMFWorkbenchEditPluginResources"); //$NON-NLS-1$
