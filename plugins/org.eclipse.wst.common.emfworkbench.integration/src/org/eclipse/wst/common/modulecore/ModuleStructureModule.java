...
public class ModuleStructureModule extends EditModel implements IResourceChangeListener {
    ...
    public ModuleStructureModule(String editModelID, EMFWorkbenchContext context, boolean readOnly) {
