...
public interface IReporter extends SeverityEnum {
	 ...
	 * is not stored. <br>
	 * <br>
	 * Both parameters must not be null. <br>
	 * <br>
	 * 
	 * @param IValidator
	...
	/**
	 * Returns the message access interface to this reporter, or null if message access is not
	 * supported.
	 */
