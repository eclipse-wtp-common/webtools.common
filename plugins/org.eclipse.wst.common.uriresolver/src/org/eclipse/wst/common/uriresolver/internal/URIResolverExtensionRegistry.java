...
public class URIResolverExtensionRegistry
{
  ...
  public static final int STAGE_PHYSICAL_RESOLUTION = 3;
   ...
   * 
   */
  public List getExtensionDescriptors(IProject project, String referenceType)
  {
    // TODO.. utilize referenceType
    //
  ...
  // URIResolverExtensionDescriptor info = (URIResolverExtensionDescriptor)
  // map.get(key);
  // return info != null ? info.getResolver() : null;
  // }
  /*
   * protected URIResolverExtensionDescriptor
   * getMatchingURIResolverExtensionDescriptor(List list, String
   * projectNatureId, String resourceType, int stage) {
   * URIResolverExtensionDescriptor result = null; for (Iterator i =
   * list.iterator(); i.hasNext(); ) { URIResolverExtensionDescriptor info =
   * (URIResolverExtensionDescriptor)i.next(); if (info.matches(projectNatureId,
   * resourceType, stage)) { result = info; break; } } return result; }
   */
}
