...
public abstract class AbstractDataModelProvider implements IDataModelProvider {
	 ...
	 * 
	 * @deprecated replace with getValidPropertyDescriptors
	 * @param propertyName
	 * @return
	 */
	protected final void doGetValidPropertyDescriptors(String propertyName) {
	}
	 ...
	 * WTPOperationDataModel should rename this method.
	 * 
	 * @deprecated replace with getPropertyDescriptor
	 * @param propertyName
	 * @return
	 */
	protected final void doGetPropertyDescriptor(String propertyName) {
	}
	 ...
	 * @return
	 */
	protected final void doGetProperty(String propertyName) {
	}
	 ...
	 * WTPOperationDataModel should rename this method.
	 * 
	 * @deprecated replace with propertySet
	 * @param propertyName
	 * @return
	 */
	protected final void doSetProperty(String propertyName, Object propertyValue) {
	}
	 ...
	 * WTPOperationDataModel should rename this method.
	 * 
	 * @deprecated replace with validate
	 * @param propertyName
	 * @return
	 */
	protected final void doValidateProperty(String propertyName) {
	}
	 ...
	 * @return
	 */
	protected final void initValidBaseProperties() {
	}
	 ...
	 * @return
	 */
	protected final void initNestedModels() {
	}
	 ...
	 * WTPOperationDataModel should rename this method.
	 * 
	 * @deprecated replace with isPropertyEnabled
	 * @param propertyName
	 * @return
	 */
	protected final void basicIsEnabled(String propertyName) {
	}
	 ...
	 * @return
	 */
	protected final void isResultProperty(String propertyName) {
	}
}
