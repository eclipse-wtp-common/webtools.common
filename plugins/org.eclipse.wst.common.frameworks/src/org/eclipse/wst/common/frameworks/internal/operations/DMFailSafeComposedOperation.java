 ...
 * list.
 */
public class DMFailSafeComposedOperation extends DMComposedOperation {

	public DMFailSafeComposedOperation() {
		super();
	}

	public DMFailSafeComposedOperation(List nestedRunnablesWithProgress) {
	...
	public void execute(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
		...
		for (int i = 0; i < fRunnables.size(); i++) {
			IDataModelOperation op = (IDataModelOperation) fRunnables.get(i);
