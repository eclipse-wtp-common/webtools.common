...
import org.eclipse.wst.common.frameworks.datamodel.DataModelOperation;
...
public class DMComposedOperation extends DataModelOperation {
	...
	public DMComposedOperation() {
		super();
	}

	public DMComposedOperation(List nestedRunnablesWithProgress) {
		super();
		fRunnables = nestedRunnablesWithProgress;
	}

	public boolean addRunnable(IDataModelOperation nestedOp) {
		return getRunnables().add(nestedOp);
	}

	public DataModelOperation append(IDataModelOperation op) {
		this.addRunnable(op);
		return this;
	}
