...
public interface IComponentCreationDataModelProperties extends IDataModelProperties {
    ...
    /**
     * Required, type String. The user defined deploy name of the component to be created.  The DataModelProvider will default
     * the name to the COMPONENT_NAME.
     */
	public static final String COMPONENT_DEPLOY_NAME = "IComponentCreationDataModelProperties.MODULE_DEPLOY_NAME"; //$NON-NLS-1$
	
    /**
     * Optional, type Boolean  The default value is <code>Boolean.TRUE</code>. If this property is set to
