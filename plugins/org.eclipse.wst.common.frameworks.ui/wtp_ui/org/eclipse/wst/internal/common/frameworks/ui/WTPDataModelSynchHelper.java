...
public class WTPDataModelSynchHelper implements WTPOperationDataModelListener {
	...
	protected Map convertPropertyNames;
	 ...
	 * @return
	 */
	protected String getConvertedProperty(String propertyName) {
		if (convertPropertyNames != null) {
			String prop = (String) convertPropertyNames.get(propertyName);
			if (prop != null)
				return prop;
		}
		return propertyName;
	 ...
	 */
	protected void setConvertProperty(String actualProperty, String convertProperty) {
		if (convertPropertyNames == null)
			convertPropertyNames = new HashMap();
		convertPropertyNames.put(actualProperty, convertProperty);
	}
